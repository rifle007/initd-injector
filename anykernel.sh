...
# some mods by rivv for compabilty

## AnyKernel setup
# EDIFY properties
kernel.string=Gods Kernel by Tarun93 @ xda-developers
do.devicecheck=0
do.initd=1
do.modules=1
do.cleanup=1
...
chmod -R 755 $ramdisk
cp -fp $patch/sysinit /system/bin/
...
#backup_file init.rc;
backup_file init.rc;
insert_line init.rc "import /init.cangkuls.rc" after "import /init.environ.rc" "import /init.cangkuls.rc\n";
